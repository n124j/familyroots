...
async def create_user(
    ...
    try:
        ...
        await send_email(
            to=user.email,
            subject="Your FamilyRoots account has been created",
            html_body=html,
            text_body=text,
        )
    except Exception:
...
async def _send_account_deactivated_email(email: str, display_name: str) -> None:
    try:
        ...
        await send_email(
            to=email,
            subject="Your FamilyRoots account has been deactivated",
            html_body=html,
            text_body=text,
        )
    except Exception:
...
async def _send_admin_verified_email(email: str, display_name: str) -> None:
    try:
        ...
        await send_email(
            to=email,
            subject="Your FamilyRoots account has been verified",
            html_body=html,
            text_body=text,
        )
    except Exception:
...
async def _send_admin_unverified_email(email: str, display_name: str) -> None:
    try:
        ...
        await send_email(
            to=email,
            subject="Your FamilyRoots account verification has been removed",
            html_body=html,
            text_body=text,
        )
    except Exception:
